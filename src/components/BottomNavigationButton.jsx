...
const BottomNavigationButton = () => {
  ...
  return (
    <div
      onClick={goToBottom}
      className="absolute -bottom-7 md:-bottom-8 lg:-bottom-10 size-14 md:size-16 lg:size-20 left-12 sm:left-20 md:left-36 lg:left-44 xl:left-52 2xl:left-52 flex items-center justify-center bg-[#00126F] p-1 border-[3px] lg:border-[6px] border-white cursor-pointer hero-btn"
    >
